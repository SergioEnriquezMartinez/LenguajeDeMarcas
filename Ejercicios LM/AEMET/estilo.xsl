		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div class="container">
					...
					<main>
						<section class="datos">
							<p><span class="titulo">Origen: </span> <xsl:value-of select="pronostico/origen/@productor" /> </p>
							<p><span class="titulo">Web: </span> <xsl:value-of select="pronostico/origen/web"/> </p>
							<p><span class="titulo">Nota legal: </span> <xsl:value-of select="pronostico/origen/nota_legal"/> </p>
						</section>
